...
%py% C:\Users\al\devel\ARBEIT\zeissGit_neu\hybif_experiments\21datalab\restservice.py C:\Users\al\devel\ARBEIT\zeissGit_neu\hybif_experiments\21datalab\models\h7a --plugin_directory ../workbench_plugins
