...
thresholdScorer5={
    "name":"thresholdScorer5",
    "type":"function",
    "functionPointer":"threshold.threshold_scorer_5",           #filename.functionname
    "autoReload":True,                                          #set this to true to reload the module on each execution
    "children":[
        {"name":"input","type":"referencer"},                   # the inputs, must be columns of one table
        {"name":"output","type":"folder","children":[           # here only the total and diff scores enc
...
thresholdScorerPipeLine = {
    "name": "thresholdScorer",
    "type": "folder",
    "children": [
        {"name": "cockpit", "type": "const", "value": "customui/thresholdscorer.htm"},
        {
            "name":"scorer",
            "type":"function",
            "functionPointer":"threshold.threshold_scorer_4",           #filename.functionname
...
def threshold_scorer_5(functionNode):
    """
    ...
    """
    logger = functionNode.get_logger()
    logger.debug(f'threshold_scorer_5() {functionNode.get_child("control").get_child("signal").get_value()}')
